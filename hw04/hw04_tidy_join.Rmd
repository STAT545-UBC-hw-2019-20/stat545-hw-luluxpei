...
We see that re-lengthening our data collapses country names back into the `country` factor column, and a single observation per year becomes to two separate observations for each country. 
...
This data table is essentially the concatenated form of the guestlist and email list - including the three guests who were not originally on the guestlist. 
